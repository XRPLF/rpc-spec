...
// Resolve one scalar tunable: use the config override if the key is present, else the default.
...
// Resolve the ramp tunable: read an array of {up_to_bytes, cost} objects if present, else the
// default.
